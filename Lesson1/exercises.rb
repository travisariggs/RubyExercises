...
new_way_hash = { Travis: 31, Riggs: 17.2 }
...
new_problem(13, 'Remove all key:value pairs whose value is less than 3.5')
...
#  (give examples)
new_problem(14, 'Can hash values be arrays? Can you have an array of hashes?')

puts
puts 'Answer:  Yes, hash values can be arrays.'
h = {a: [1,2,3], b: ["hello", "goodbye"]}
puts "Hash h: #{h}"
puts "h class: #{h.class}"
puts "h[:a] class: #{h[:a].class}"

puts
puts 'Answer:  Yes, you can have an array of hashes.'
a = [ { a: 1, b: 2 }, { 'hi' => 'Hello', d: 2 } ]
puts "Array a: #{a}"
...
new_problem(15, 'Look at several Rails/Ruby online API sources and say ' + 
						'which one your like best and why.')

puts
puts "Answer:  I'm pretty satisified with ruby-doc.org, mainly because"
puts "it's the only one I really found.  I don't really want to look"
puts "at any Rails documentation because it will probably confuse me"
puts "right now."
